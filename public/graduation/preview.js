async function loadPreviewData() {
    ...
    document.getElementById('graduate-info').textContent = `${info.universityShort} — Ngày ${info.date}`;
    ...
    document.getElementById('event-venue').textContent  = info.venue.replace(/<br>/g, " ");
