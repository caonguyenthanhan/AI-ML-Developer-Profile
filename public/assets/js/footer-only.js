            ...
            <div class="max-w-6xl mx-auto px-4 py-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="space-y-2 text-sm">
                            <a href="/public/caonguyenthanhan/personal_info.html" class="block hover:text-indigo-300 transition duration-300">
                                <i data-lucide="user-circle" class="w-4 h-4 mr-2 inline"></i>
                                Hồ Sơ CV
                            </a>
                            <a href="/public/nlp/nlp.html" class="block hover:text-indigo-300 transition duration-300">
                                <i data-lucide="brain" class="w-4 h-4 mr-2 inline"></i>
                                NLP Projects
                            </a>
                            <a href="/public/genai/genai.html" class="block hover:text-indigo-300 transition duration-300">
                                <i data-lucide="sparkles" class="w-4 h-4 mr-2 inline"></i>
                                GenAI Tools
                            </a>
                            <a href="/public/extension/extensions.html" class="block hover:text-indigo-300 transition duration-300">
